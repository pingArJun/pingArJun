...
<div align="center">
  ...
  ![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=00FF00&center=true&vCenter=true&random=false&width=600&lines=%24+whoami;Cybersecurity+Enthusiast+%7C+Ethical+Hacker;Penetration+Tester+%7C+Bug+Hunter;%24+cat+%2Fetc%2Fpasswd+%7C+grep+passion;Always+Learning%2C+Always+Hacking...)

  <img src="https://komarev.com/ghpvc/?username=pingArJun&style=for-the-badge&color=00ff00&labelColor=000000&label=PROFILE+VIEWS" alt="Profile Views"/>

</div>

---

<img align="right" alt="Hacking" width="400" src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExcTd4OWZrOWV5NzR4Z2o0OGV6OXJ2b2xkd2V1dGVsZTV6aGFnMnF0aCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/077i6AULCXc0FKTj9s/giphy.gif">
...
class CyberSecurityEnthusiast:
    def __init__(self):
        ...
        self.language_spoken = ["en_US", "code"]

    def say_hi(self):
        print("""
        Thanks for dropping by!
        I break things to understand them,
        then fix them to make them stronger.
        """)
...
│  🕵️ OSINT                  │  🔍 Vulnerability   │
│  🛡️ Blue Team              │  ⚔️ Red Team        │
│  🌐 Web Security           │  📱 Mobile Security │
│  🔐 Cryptography           │  🖥️ Network Security│
└──────────────────────────────────────────────────┘
```
...
### `> find / -name "connect" 2>/dev/null`

<div align="center">

[![GitHub](https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white)](https://github.com/pingArJun)
